...
public class MainStatistics {
    ...
    public MainStatistics(String fileName, int count) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        MainStatistics m = new MainStatistics("log.csv", 100000);
        m.Run();
        m.End();
    }
    ...
    public void Run() throws IOException {
        ...
        Test("greedy optimised", new GreedyOptimised1());
    }
